...
class RiskExport implements FromCollection, WithHeadings, WithEvents, WithCustomStartCell, WithDrawings, ShouldAutoSize
{
    ...
    public function collection()
    {
        ...
        $newArr = (new RisksServices())->getRiskRegisterData($BunitID);
    ...
    public function registerEvents(): array
    {
        ...
        return (new ExportHelper($this->headerRow, $this->busineesUnitObjectives, $this->businessUnitName))->registerEventsHelper();
    }
}
