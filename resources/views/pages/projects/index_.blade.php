...
<div
	...
	<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
		...
		<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10" id="kt_aside_logo">		
			<a href="index-2.html">
				<img alt="Logo" src="{{ assets('assets/media/logos/logo-default.svg')}}" class="h-50px"/>
			</a>
		</div>
		<!--end::Logo-->
...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
	<!--begin::Heading-->
    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ assets("assets/media/misc/pattern-1.html")}}')">
        <!--begin::Title-->
        ...
        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
            ...
            <div class="d-flex flex-column px-9">
                ...
                <div class="text-center px-4">
                    <img class="mw-100 mh-200px" alt="metronic" src="{{ assets('assets/media/illustrations/sigma-1/6.png')}}"/>
                </div>
                <!--end::Illustration-->
            </div>
            <!--end::Wrapper-->
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_65e190e1c59a2">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" multiple data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_65e190e1c59a2" data-allow-clear="true">
                    <option></option>
...
<!--end::Page title--->     
    ...
    <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
      ...
      <div class="btn btn-icon btn-active-icon-primary" id="kt_aside_toggle">
        <i class="ki-duotone ki-abstract-14 fs-2x"><span class="path1"></span><span class="path2"></span></i>      </div>
...
<div class="d-flex flex-shrink-0">
    ...
    <div class="d-flex ms-3">
        <a href="#" class=" btn bg-body btn-color-gray-600 btn-active-info" tooltip="New Member"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_account" >
            New User
        </a>
    </div>
    <!--end::Invite user--> 
    ...
    <!--begin::Create app-->
    <div class="d-flex ms-3">
        <a href="#" class="btn btn-info" tooltip="New App"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign" >
           New Goal
        </a>
    </div>
    <!--end::Create app-->   
                ...
                <div id="kt_schedule_day_0" class="tab-pane fade show ">
                        ...
                        <div class="d-flex flex-stack position-relative mt-8">
                            ...
                            <div class="fw-semibold ms-5 text-gray-600">
                                ...
                                <!--begin::Title-->
                                <a href="#" class="fs-5 fw-bold text-gray-800 text-hover-success mb-2">
...
<div class="footer py-4 d-flex flex-lg-column " id="kt_footer">
	...
	<div class=" container-xxl  d-flex flex-column flex-md-row flex-stack">
		...
		<div class="text-dark order-2 order-md-1">
			...
			<a href="https://keenthemes.com/" target="_blank" class="text-muted text-hover-success fw-semibold me-2 fs-6">Keenthemes</a>
		</div>
		<!--end::Copyright-->
		...
		<ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
			...
			<li class="menu-item"><a href="https://keenthemes.com/products/seven-html-pro" target="_blank" class="menu-link px-2">Purchase</a></li>
		</ul>
		<!--end::Menu-->
	</div>
	<!--end::Container-->
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="overflow-auto pb-5">
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">  
                <!--begin::Title-->                                   
                <a href="#" class="fs-5 text-dark text-hover-success fw-semibold w-375px min-w-200px">Meeting with customer</a>                                  
                <!--end::Title-->
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">  
                <!--begin::Title-->                                   
                <a href="#" class="fs-5 text-dark text-hover-success fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>                                  
                <!--end::Title-->
...
<div class="timeline-item">
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="mb-5 pe-3">
            <!--begin::Title-->
            <a href="#" class="fs-5 fw-semibold text-gray-800 text-hover-success mb-2">3 New Incoming Project Files:</a>
            <!--end::Title-->
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">  
                    ...
                    <div class="ms-1 fw-semibold">
                        <!--begin::Desc--> 
                        <a href="#" class="fs-6 text-hover-success fw-bold">Finance KPI App Guidelines</a>
                        <!--end::Desc--> 
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">   
                    ...
                    <div class="ms-1 fw-semibold">
                        <!--begin::Desc--> 
                        <a href="#" class="fs-6 text-hover-success fw-bold">Client UAT Testing Results</a>
                        <!--end::Desc--> 
                ...
                <div class="d-flex flex-aligns-center">   
                    ...
                    <div class="ms-1 fw-semibold">
                        <!--begin::Desc--> 
                        <a href="#" class="fs-6 text-hover-success fw-bold">Finance Reports</a>
                        <!--end::Desc--> 
        ...
        <div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
            ...
            <div class="card-title">
                ...
                <div class="d-flex justify-content-center flex-column me-3">
                    <a href="#" class="fs-4 fw-bold text-gray-900 text-hover-success me-1 mb-2 lh-1">Brian Cox</a>
    ...
    <div class="d-flex justify-content-start mb-10 " >
        ...
        <div class="d-flex flex-column align-items-start">
            ...
            <div class="d-flex align-items-center mb-2">
                    ...
                    <!--begin::Details-->
                    <div class="ms-3">
                        <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success me-1">Brian Cox</a>
        ...
        <div class="d-flex flex-column align-items-end">
            ...
            <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="me-3">
                        ...
                        <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success ms-1">You</a>  
                    </div>
                    <!--end::Details-->
        ...
        <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="#" class="text-gray-800 text-hover-success fs-4 fw-bold">Iblender</a>
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="#" class="text-gray-800 text-hover-success fs-4 fw-bold">SmartCleaner</a>
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="#" class="text-gray-800 text-hover-success fs-4 fw-bold">CameraMaxr</a>
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="#" class="text-gray-800 text-hover-success fs-4 fw-bold">$D Printer</a>
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="#" class="text-gray-800 text-hover-success fs-4 fw-bold">MotionWire</a>
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->                                  
                        <div class="mb-3">
                            <a href="#" class="text-gray-800 text-hover-success fs-4 fw-bold">Samsung</a>
...
<div class="mb-5">
    <!--begin::Comparision-->
    <table class="table table-row-dashed table-row-gray-300 align-middle fs-6 fw-semibold text-gray-800 gs-0 gy-3">
        <tr class="border-bottom-0">
            <th class="fw-bold text-dark fs-3">Pro Version Benefits</th>
            <th class="text-center">
                <span class="bg-light py-2 px-4 fw-semibold fs-6 rounded">Free</span>
            </th>
            <th class="text-center">
                <span class="bg-light py-2 px-4 fw-semibold fs-6 rounded">Pro</span>
            </th>
        </tr>        
                ...
                <td class="text-center">
                    ...
                    <tr>
                <td>
                    Complete Documentation                </td>
                <td class="text-center">
                                            <i class="ki-duotone ki-check-circle fs-2 explore-icon-success"><span class="path1"></span><span class="path2"></span></i>       
                                    </td>                
                <td class="text-center">
                                            <i class="ki-duotone ki-check-circle fs-2 explore-icon-success"><span class="path1"></span><span class="path2"></span></i>       
                                    </td>
                ...
                <td>
                    Product Support                </td>
                <td class="text-center">
                                            <i class="ki-duotone ki-cross-circle fs-2 explore-icon-danger"><span class="path1"></span><span class="path2"></span></i>                                    </td>                
                <td class="text-center">
                                            <i class="ki-duotone ki-check-circle fs-2 explore-icon-success"><span class="path1"></span><span class="path2"></span></i>       
                                    </td>
            </tr>
...
<!--begin::Link-->
<a href="https://keenthemes.com/products/seven-html-pro" class="btn btn-lg explore-btn-primary w-100">
	Upgrade to <span class="fw-bold ms-1">Seven HTML Free</span>
</a>
<!--end::Link-->				
							</div>
			<!--end::Content-->
		...
		<!--end::Body-->
			...
			<div class="card-footer py-5 text-center" id="kt_explore_footer">
				<a href="https://keenthemes.com/products/seven-html-free" class="btn btn-lg explore-btn-secondary w-100">
					Download <span class="fw-bold ms-1">Seven HTML Free</span>
				</a>    
			</div>
			<!--end::Footer-->
			</div>
		...
		<div class="card-body" id="kt_help_body">
			...
			<div 
				...
				<!--end::Support-->
														...
														<!--begin::Link-->
					<a href="https://preview.keenthemes.com/html/seven-html-pro/docs"  class="parent-hover d-flex align-items-center mb-7">
						<!--begin::Icon-->
					...
					<!--end::Link-->
														<!--begin::Link-->
					<a href="https://preview.keenthemes.com/html/seven-html-pro/docs/base/utilities"  class="parent-hover d-flex align-items-center mb-7">
						<!--begin::Icon-->
					...
					<!--end::Link-->
																			<!--begin::Link-->
					<a href="https://preview.keenthemes.com/html/seven-html-pro/docs/getting-started/changelog"  class="parent-hover d-flex align-items-center mb-7">
						<!--begin::Icon-->
        ...
        <div class="mb-0">
            ...
            <label class="d-flex flex-stack mb-5 cursor-pointer">
                ...
                <span class="d-flex align-items-center me-2">
                    ...
                    <span class="d-flex flex-column">
                        <span class="fw-bold text-gray-800 text-hover-success fs-5">Company Account</span>
            ...
            <label class="d-flex flex-stack mb-5 cursor-pointer">
                ...
                <span class="d-flex align-items-center me-2">
                    ...
                    <!--begin::Description-->
                    <span class="d-flex flex-column">
                        <span class="fw-bold text-gray-800 text-hover-success fs-5">Developer Account</span>
            ...
            <label class="d-flex flex-stack mb-0 cursor-pointer">
                ...
                <span class="d-flex align-items-center me-2">
                    ...
                    <!--begin::Description-->
                    <span class="d-flex flex-column">
                        <span class="fw-bold text-gray-800 text-hover-success fs-5">Testing Account</span>
            ...
            <div class="mh-300px scroll-y me-n7 pe-7">
                    ...
                    <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Product Specifications</a>
                    ...
                    <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Campaign Creative Poster</a>
                    ...
                    <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Campaign Landing Page Source</a>
                    ...
                    <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Landing Page Styling</a>
                    ...
                    <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Design Source Files</a>
                    ...
                    <div class="d-flex flex-stack py-4 ">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Campaign Plan Document</a>
...
<span class="ms-1"  data-bs-toggle="tooltip" title="Enter one or more location points for more specific targeting." >
	<i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>            </label>
            ...
            <!--begin::Tagify-->
            <input class="form-control d-flex align-items-center" value="" id="kt_modal_create_campaign_location" data-kt-flags-path="/seven-html-free/assets/media/flags/"/>
            <!--end::Tagify-->
        </div>
        <!--end::Input group-->
                    ...
                    <div class="mh-375px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-6">
                                        <!--begin::Name-->
                                        <a href="#" class="d-flex align-items-center fs-5 fw-bold text-dark text-hover-success">
                                            Emma Smith   
...
<!--end::Modal - View Users--><!--begin::Modal - Create Project-->
            ...
            <div class="mh-300px scroll-y me-n7 pe-7">
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Emma Smith</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Melody Macy</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Max Smith</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Sean Bean</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Brian Cox</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Mikaela Collins</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Francis Mitcham</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Olivia Wild</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Neil Owen</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Dan Wilson</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Emma Bold</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Ana Crown</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Robert Doe</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">John Miller</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Lucy Kunic</a>
                    ...
                    <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-5">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Ethan Wilder</a>
            ...
            <div class="mh-300px scroll-y me-n7 pe-7">
                    ...
                    <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Avionica Technical Requirements</a>
                                <div class="fw-semibold text-muted">230kb</div>
                            </div>
                            <!--end::Details-->
                        </div>
                    ...
                    <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">9 Degree CURD draftplan</a>
                    ...
                    <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">User CRUD Styles</a>
                                <div class="fw-semibold text-muted">85kb</div>
                            </div>
                            <!--end::Details-->
                        </div>
                    ...
                    <div class="d-flex flex-stack py-4 border border-top-0 border-left-0 border-right-0 border-dashed">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Design Initial Logo</a>
                    ...
                    <div class="d-flex flex-stack py-4 ">
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Details-->
                            <div class="ms-6">
                                <a href="#" class="fs-5 fw-bold text-gray-900 text-hover-success mb-2">Tower Hill Bilboard</a>
...
<!--end::Modal - Create App--><!--begin::Modal - New Address-->
...
<!-- Mirrored from preview.keenthemes.com/seven-html-free/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 01 Mar 2024 08:26:05 GMT -->
</html>