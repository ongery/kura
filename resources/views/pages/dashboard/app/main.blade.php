        ...
        <div class="table-responsive">
            ...
            <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                ...
                <tbody>
                            ...
                            <td class="ps-0">
                                <a href="apps/ecommerce/sales/details.html" class="text-gray-800 fw-bold text-hover-success mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                            ...
                            <td class="ps-0">
                                <a href="apps/ecommerce/sales/details.html" class="text-gray-800 fw-bold text-hover-success mb-1 fs-6 text-start pe-0">Red Laga</a>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
                            </td>
                            <td>                                            
                            ...
                            <td class="ps-0">
                                <a href="apps/ecommerce/sales/details.html" class="text-gray-800 fw-bold text-hover-success mb-1 fs-6 text-start pe-0">RiseUP</a>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
                            </td>
                            <td>                                            
                            ...
                            <td class="ps-0">
                                <a href="apps/ecommerce/sales/details.html" class="text-gray-800 fw-bold text-hover-success mb-1 fs-6 text-start pe-0">Yellow Stone</a>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
                            </td>
                            <td>                                            
                                <span class="text-gray-800 fw-bold d-block fs-6 ps-0 text-end">$72.00</span>
        ...
        <div class="mb-0">     
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center me-5">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Search Retargeting</a>
                            <!--end::Title-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center me-5">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Social Retargeting</a>
                            <!--end::Title-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center me-5">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Email Retargeting</a>
                            <!--end::Title-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center me-5">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Referrals Customers</a>
                            <!--end::Title-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center me-5">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Other</a>
                            <!--end::Title-->
        ...
        <div class="m-0">   
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">United States</a>
                            <!--end::Title-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Brasil</a>
                            <!--end::Title-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Turkey</a>
                            <!--end::Title-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">France</a>
                            <!--end::Title-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">India</a>
                            <!--end::Title-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Sweden</a>
                            <!--end::Title-->
    ...
    <div class="card-body card-body d-flex justify-content-between flex-column pt-3">                 
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Dribbble</a>
                        <!--end::Title-->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Linked In</a>
                        <!--end::Title-->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Slack</a>
                        <!--end::Title-->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">YouTube</a>
                        <!--end::Title-->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Instagram</a>
                        <!--end::Title-->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Facebook</a>
                        <!--end::Title-->
        ...
        <div class="w-100">           
                ...
                <div class="d-flex align-items-center">                    
                    ...
                    <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Direct Source</a>
                            <!--end::Title-->
                ...
                <div class="d-flex align-items-center">                    
                    ...
                    <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Social Networks</a>
                            <!--end::Title-->
                ...
                <div class="d-flex align-items-center">                    
                    ...
                    <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Email Newsletter</a>
                            <!--end::Title-->
                ...
                <div class="d-flex align-items-center">                    
                    ...
                    <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                        ...
                        <div class="me-5">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-800 fw-bold text-hover-success fs-6">Referrals</a>
                            <!--end::Title-->
