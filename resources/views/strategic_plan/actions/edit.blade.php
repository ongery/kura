...
<div class="card">
    ...
    <div class="card-body">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <form action="{{ route('myactions.update', $row->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method("PUT")
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="description" placeholder="Description" class="form-control" value="{{ $row->description }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
