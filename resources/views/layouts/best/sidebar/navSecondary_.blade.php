                ...
                <div class="m-0">
                    ...
                    <div class="mb-10">
                        ...
                        <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                            ...
                            <div class="symbol symbol-40px me-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('assets/media/svg/brand-logos/beats-electronics.svg')}}" class="h-50 align-self-center" alt=""/>                
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                            ...
                            <div class="symbol symbol-40px me-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('assets/media/svg/brand-logos/rgb.svg')}}" class="h-50 align-self-center" alt=""/>                
                                </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                            ...
                            <div class="symbol symbol-40px me-5">
                                <span class="symbol-label">
                                    <img src="{{ asset('assets/media/svg/brand-logos/disqus.svg')}}" class="h-50 align-self-center" alt=""/>                
                                </span>
                            </div>
                            <!--end::Symbol-->
            ...
            <div class="mx-5">                   
                ...
                <div class="text-center px-4">
                    <img class="mw-100 mh-300px" alt="" src="{{ asset('assets/media/illustrations/sigma-1/1.png')}}"/>
                </div>
                <!--end::Illustration-->              
            </div>
