...
// Class definition
var KTCardsWidget119 = function () {
    // Private methods
    var initChart = function() {
        var el = document.getElementById('kt_card_widget_119_chart'); 
...
// Webpack support
if (typeof module !== 'undefined') {
    module.exports = KTCardsWidget119;
}

// On document ready
KTUtil.onDOMContentLoaded(function() {
    KTCardsWidget119.init();
});
...
// Class definition
var KTCardsWidget4th = function () {
    // Private methods
    var initChart = function() {
        var el = document.getElementById('kt_card_widget_4_th_chart'); 
        ...
        var options = {
            ...
            lineWidth: el.getAttribute('data-kt-line') ? parseInt(el.getAttribute('data-kt-line')) : 11,
            rotate: el.getAttribute('data-kt-rotate') ? parseInt(el.getAttribute('data-kt-rotate')) : 145,            
            // percent:  el.getAttribute('data-kt-percent')  ? parseInt(el.getAttribute('data-kt-percent')) : 45,
        }
        ...
        // Init 
        drawCircle('#E4E6EF', options.lineWidth, 100 / 100); 
        // drawCircle('#EC0D0D', options.lineWidth, 100 / 150);// 150
        // drawCircle('#EC0D0D', options.lineWidth, 100 / 250);   
...
// Webpack support
if (typeof module !== 'undefined') {
    module.exports = KTCardsWidget4th;
}

// On document ready
KTUtil.onDOMContentLoaded(function() {
    KTCardsWidget4th.init();
});
