...
<!-- <div class="card card-flush h-md-50 mb-4"> -->
    ...
    <!-- <div class="card-header pt-5"> -->
        ...
        <div class="card-title d-flex flex-column">   
            ...
            <div class="d-flex align-items-center">
                ...
                <span class="card-label fw-bold text-dark">Medium Risk</span>
                <!--end::Title-->
            </div>
            <!--end::Info--> 
    ...
    <div class="card-body pt-2 pb-4 d-flex align-items-center">
        ...
        <div class="d-flex flex-column flex-center align-items-center">
            ...
            <!--begin::Stats-->
            <div class="fw-bolder text-gray-700 pr-1 pb-3 fs-2hx ">{{ summaryReports.totalMediumRisks}}</div>
            <!--end::Stats-->


            <!--begin::Label-->
            <div class="text-gray-500 flex-grow-1">Medium Risk</div>
            <!--end::Label-->
