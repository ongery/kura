        ...
        <div class="card ml-1">
                     ...
                     <!-- <div class="symbol symbol-45px w-45px bg-light me-5"> -->
                        ...
                        <div class="d-flex flex-column pt-2 col-2"  >
                            ...
                            <!-- <OctagonHighRisk :risk="summaryReports"></OctagonHighRisk> -->
                                ...
                                <!-- aquamarine -->
                                    <!--begin::Item-->
                                    <div class="octagon d-flex flex-center h-35px w-35px"  style="background-color:#09f17d; margin-top: -17px;">
            ...
            <div class="card-body d-flex flex-column px-9" >
                ...
                <!-- <div class="fs-2tx fw-bold ml-9" style="margin-top: -15px; margin-left: 8px">
                 ...
                 <!--begin::Animation-->
                 <div class="d-flex align-items-center">
                    <div class="text-dark text-white-400 fs-2tx fw-bold ml-9" style="margin-top: -15px; margin-left: 8px" data-kt-countup="true" :data-kt-countup-value="summaryReports.totalGreenRisks">{{ summaryReports.totalGreenRisks}}</div>                      
