          ...
          <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-lg-row-fluid me-xl-15 mb-10 mb-xl-0">
              ...
              <div class="d-flex flex-stack flex-wrap mb-lg-10">
                ...
                <!-- <h1 class="card-title align-items-start flex-column  d-flex text-gray-400 pt-1 fw-semibold fs-5 ml-4 flex-column justify-content-start"> -->
                ...
                <h1  class="text-gray-800 text-hover-success fw-bold" style="font-size: 16px;">{{mode.Name}}</h1>
                ...
                <div v-for="(mode1, innerIndex) in mode.riskData" :key="innerIndex">
                  ...
                  <div class="m-0 pl-5 pt-2">
                    ...
                    <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0" data-bs-toggle="collapse" :data-bs-target="'#accordion_' + outerIndex + '_' + innerIndex">
						...
						<h5 class="custom-list-title fw-bold text-gray-700 mb-1">{{mode1.RiskName}}</h5>
					...
					<!--begin::Card header-->
					<!-- <div class="card-header align-items-center cursor-pointer collapsible py-3 toggle collapsed mb-0" data-bs-toggle="collapse" :data-bs-target="'#accordion_' + outerIndex + '_' + innerIndex"> -->
						    
						<!-- <span> -->
							
							<!--begin::Card title-->
							<!-- <div class="card-title"> -->
								<!-- <h4 style="margin-left: 38px;" class="text-gray-700 fw-bold fs-3 cursor-pointer mb-0">{{mode1.RiskName}}</h4> -->
								
								<!-- <span style="margin-left: 38px;"  class="card-title custom-list-title fw-bold text-gray-800 text-hover-success mb-1">{{mode1.RiskName}}</span> -->
                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="align-items: center; ">
                                                <OctagonResidualValue :mode1="mode1"></OctagonResidualValue>
                                        ...
                                        <tr>
                                            ...
                                            <td  class="text-center">
                                                ...
                                                <span class="text-muted fw-bolder d-block">{{mode1.TotalQuestions}}</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td  class="text-center">
                                                ...
                                                <span class="text-muted fw-bolder d-block">{{mode1.TotalKRIs}}</span>
                                            </td>
                                            <!-- <td class="text-end text-muted fw-bold">React, HTML</td> -->

                                            <td  class="text-center" style="background-color: red;"><!-- Red -->
                                            	<a href="#" class="text text-dark  text-hover-success mb-1 ">Red KRIs</a>
                                                <span class="text text-dark fw-bolder d-block">{{mode1.RedKRIs}}</span>
                                            </td>
                                            <!-- <td class="text-end">
                                                <span class="badge badge-light-success">Approved</span>
                                            </td> -->
                                        ...
                                        <tr>
                                            ...
                                            <td  class="text-center" style="background-color: red; "><!-- Yellow -->
                                                ...
                                                <span class="text text-dark fw-bolder d-block">{{mode1.NotStartedOverdue}}</span>
                                            </td>
                                            <!-- <td class="text-end text-muted fw-bold">React, HTML</td> -->
