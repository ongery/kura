        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                ...
                <div class="d-flex flex-stack flex-wrap mb-10 mb-lg-15">
                    <!--begin::Logo-->
                    <a href="#">
                        <img alt="Logo" class="h-50px" src="assets/media/svg/brand-logos/the-blockchain-group-tbg.svg" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Actions-->
                    <div class="my-2">
            ...
            <div class="m-0">
                ...
                <div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 min-w-md-350px p-9 bg-lighten">
                    ...
                    <!--end::Labels-->
                    <!--begin::Title-->
                    <h6 class="mb-8 fw-boldest text-gray-600 text-hover-success">PAYMENT DETAILS</h6>
                    <!--end::Title-->
                    <!--begin::Item-->
                    <div class="mb-6">
                    ...
                    <!--end::Item-->
                    <!--begin::Title-->
                    <h6 class="mb-8 fw-boldest text-gray-600 text-hover-success">PROJECT OVERVIEW</h6>
                    <!--end::Title-->
                    <!--begin::Item-->
                    <div class="mb-6">
