<template>
    ...
    <div>
    <!-- No Data Placeholder -->
    <div v-if="!this.selectedItems.Name">
            ...
            <!--begin::Header-->
              <div class="card-header border-0 pt-5">
                ...
                <div class="col-md-8 fv-row" style="margin:auto">
                  ...
                  <h3  class="text-gray-400 text-muted text-hover-success fw-bold" style="font-size: 20px; margin-top: 21px;  margin-left: 65px;">Select Department </h3>
     ...
     <div  v-else>
        ...
        <div class="card-header border-0 pt-5">
            ...
            <div class="col-md-8 fv-row">
              ...
              <h3  class="text-gray-800 text-hover-success fw-bold" style="font-size: 20px; margin-top: 21px;">{{selectedItems.Name}}</h3>
