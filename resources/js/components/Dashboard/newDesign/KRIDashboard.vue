<template>
    <div>
            ...
            <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack ">
                <div class="mb-2 mt-4 page-title d-flex flex-column justify-content-start flex-wrap">
                    <div class="d-flex">
                        ...
                        <div>
                            <h1 class="page-heading d-flex text-dark text-white-400 fw-bold fs-3 flex-column"> KRI Dashboard </h1>
        ...
        <KRIDashboardContent></KRIDashboardContent>
    </div>
</template>
<script>
    import KRIDashboardContent from './KRIDashboardContent.vue';

    export default {
        name: 'KRIDashboard',
        components: { KRIDashboardContent },
    }
</script>
