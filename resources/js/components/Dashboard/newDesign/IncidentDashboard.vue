<template>
    <div>
            ...
            <div id="kt_app_toolbar_container" class="app-container d-flex flex-stack ">
                <div class="mb-2 mt-4 page-title d-flex flex-column justify-content-start flex-wrap">
                    <div class="d-flex">
                        ...
                        <div>
                            <h1 class="page-heading d-flex text-dark text-white-400 fw-bold fs-3 flex-column"> Incident Dashboard </h1>
        ...
        <IncidentDashboardContent></IncidentDashboardContent>
    </div>
</template>
<script>
    import IncidentDashboardContent from './IncidentDashboardContent.vue';

    export default {
        name: 'IncidentDashboard',
        components: { IncidentDashboardContent },
    }
</script>
