<template>
    ...
    <div class="app-toolbar py-3">
      ...
      <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
          ...
          <div class="mb-2 mt-4 page-title d-flex flex-column justify-content-start flex-wrap">       
              ...
              <ol style="margin-left: -6px;" role="list" class="flex items-center space-x-4 breadcrumb  breadcrumb-separatorless text-gray-400 fw-semibold pt-1">
                  ...
                  <!--end::Item-->
                        ...
                        <!--begin::Item-->
                        <li v-if="title != 'Audit Scheduler'" class="breadcrumb-item text-muted">
          ...
          <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <NewItemButton v-if="title === 'Audit Scheduler'"></NewItemButton>
            <BackButton v-if="title != 'Audit Scheduler'"></BackButton>
  ...
  export default {
      name:'AuditToolbar',
      props:['title', ],
      components:{BackButton,NewItemButton},
