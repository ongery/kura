    ...
    <div class="app-toolbar py-3">
      ...
      <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
          ...
          <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <AllKRIsButton v-if="title === 'My Key Control Indicators'"></AllKRIsButton>
            <AddKeyControlButton v-if="title === 'All Key Control Indicators'"></AddKeyControlButton>
            <BackButton v-if="title != 'My Key Control Indicators'"></BackButton>
...
import AllKRIsButton from './AllKRIsButton.vue';
import AddKeyControlButton from './AddKeyControlButton.vue';
  
  export default {
      name:'KCIRiskToolbar',
      props:['title', ],
      components:{AddKeyControlButton, AllKRIsButton, BackButton },
  }
  </script>