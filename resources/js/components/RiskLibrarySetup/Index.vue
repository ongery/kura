<template>
    <div>
        ...
        <div class="app-toolbar py-3">
            ...
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <a href="#" class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-success" @click.prevent="showEvents"><b>Risk Events</b></a>
                    <a href="#" class="btn btn-sm fw-bold bg-body btn-color-gray-700tn-info btn-active-color-success" @click.prevent="showRiskCasues"><b>Risk Sources</b></a>
                    <a href="#" class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-success" @click.prevent="showImpacts"><b>Risk Impacts</b></a>
                    <a href="#" class="btn btn-sm fw-bold bg-body btn-color-gray-700 btn-active-color-success" @click.prevent="showScaleGroup"><b>Control Items</b></a>
                </div>
                <!--end::Actions-->
            </div>
        ...
        <RiskEvents v-else-if="showmode === 'events'"></RiskEvents>
...
import RiskEvents from './_componets/RiskEvents'
import RiskImpacts from './_componets/RiskImpacts'
import ScaleGroup from './_componets/ControlItems'
export default {
    data() {
        return {
            showmode: '',
    ...
    methods: {
        showRiskCasues() {
            ...
            this.showTitle = 'Risk Sources'
        },
        showEvents() {
            this.showmode = 'events'
            this.showTitle = 'Risk Events'
        },
        showImpacts() {
            this.showmode = 'impacts'
            this.showTitle = 'Risk Impacts'
        },
        showScaleGroup() {
            this.showmode = 'scalegroup'
            this.showTitle = 'Control Items'
        }
    },
    created() {
        this.showEvents()
