<template>
  <div>
    <KRIRiskToolbar :title="'My KRI Items'"></KRIRiskToolbar>

    <div class="row mt-2">
      <div class="col-md-12">
        <div class="card">
          <!-- <div class="card-header">
            <h3 class="card-title">My KRI Items</h3>
                                ...
                                <tr v-for="mode in alldata" :key="mode.id">
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start flex-column">
                                          <a style="color: #258c37;" href="#" @click.prevent="attestModal(mode)">{{ mode.DocNum }} </a>
                                        </div>
                                    </td>
                                    ...
                                    <td  :class="{
                                      ...
                                      'bg-danger': mode.color === 'bg-danger',
                                        ...
                                        <a class="text-dark fw-bolder text-hover-success d-block fs-6">{{ mode.activeKRI1 ?  mode.activeKRI1.Value : "PENDING" }}</a>
                                        <!-- <span class="text-muted fw-bold text-muted d-block fs-7">Web, UI/UX Design</span> -->
                                    </td>
    ...
    deleteRoute(id) {
      ...
      swal
        ...
        axios.post('/api/manage-logs', {
            'page_name': 'My KRI Items',
            'log': 'User visited to the My KRI Items'
        }, {
            withCredentials: true,
            headers: {
                'Authorization': `Bearer ${token}`
