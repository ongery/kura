      ...
      <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
          ...
          <div class="mb-2 mt-4 page-title d-flex flex-column justify-content-start flex-wrap">       
              ...
              <ol style="margin-left: -6px;" role="list" class="flex items-center space-x-4 breadcrumb  breadcrumb-separatorless text-gray-400 fw-semibold pt-1">
                  ...
                  <!--begin::Item-->
                  <li class="breadcrumb-item text-muted"  v-if="title != 'Edit KCI'">
          ...
          <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <ButtonAllKRIs v-if="title === 'My KRI Items'"></ButtonAllKRIs>
            <ButtonNewKRIItem v-if="title === 'All KRI Items'" ></ButtonNewKRIItem>
            <ButtonMyKRIs v-if="title === 'All KRI Items'"></ButtonMyKRIs>
            <BackButton v-if="title === 'New KRI'"></BackButton>
            <BackButton v-if="title === 'Edit KRI'"></BackButton>
            <BackButton v-if="title === 'Edit KCI'"></BackButton>
...
import ButtonAllKRIs from './ButtonAllKRIs.vue';
import ButtonMyKRIs from './ButtonMyKRIs.vue';
import ButtonNewKRIItem from './ButtonNewKRIItem.vue';
import BackButton from './BackButton.vue';
  
  export default {
      name:'KRIRiskToolbar',
      props:['title', ],
      components:{ButtonAllKRIs, ButtonMyKRIs, ButtonNewKRIItem, BackButton },
  }
  </script>