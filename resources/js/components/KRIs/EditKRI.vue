<template>
  <div class="row mt-2">
    ...
    <KRIRiskToolbar :title="'Edit'+' '+this.objectName"></KRIRiskToolbar>
    ...
    <div class="row card card-body p-12 m-1">
      ...
      <h1 class="fw-bold text-dark text mb-9">Details</h1>
          ...
          <!-- <a href="#" @click="showRiskCauses"  class="badge badge-light p-6 mb-6 mt-5  col-md-6 " style="font-size:medium" >Select Assignments</a> -->
