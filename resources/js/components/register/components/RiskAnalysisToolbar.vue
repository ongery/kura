  ...
  <div class="app-toolbar py-3">
    ...
    <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
            ...
            <ol style="margin-left: -6px;" role="list" class="flex items-center space-x-4 breadcrumb  breadcrumb-separatorless text-gray-400 fw-semibold pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                      ...
                      <div class="flex items-center">
                        ...
                        <span class="text-gray-500 mt-1 fw-semibold fs-6 text-muted ">
                          Risk Analysis
                        </span>
                      ...
                      <!--end::Item-->
                        ...
                        <li class="breadcrumb-item text-muted">
                            ...
                            <div class="flex items-center">
                              -
                                <span class="text-gray-500 mt-1 fw-semibold fs-6 text-muted ml-4 text-hover-success">
                                  {{ title }}
                            </span>
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
          ...
          <AddNewRisk1Button v-if="title === 'Risks 1'"></AddNewRisk1Button>
...
import AddNewRisk1Button from './items/AddNewRisk1Button.vue';

export default {
    name:'RiskAnalysisToolbar',
    props:['title', ],
    components:{AddNewRisk1Button,},
}
</script>