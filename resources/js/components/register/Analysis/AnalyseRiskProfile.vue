                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            <nav class="nav nav-tabs">
                                ...
                                <!-- <a href="javascript:void(0)" class="nav-item nav-link" @click.prevent="showRiskCauses">Risk Events</a> -->
                        ...
                        <!-- <RiskEvents v-if="showcauses"></RiskEvents> -->
...
export default {
    data() {
        return {
            ...
            scalesgroup: {},
            scalesgroupResidual: {},
            ConsequenceFandamentalIRL: {},
            ConsequenceFandamentalRRL: {},
            controlitems: {},
            alltreament: {},
            BName: '',
            RName: '',
