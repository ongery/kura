    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-header mb-3">
          ...
          <h3  class="text-gray-800 text-hover-success fw-bold" style="font-size: 20px; margin-top: 21px;">Current Controls</h3>
        ...
        <!-- <div class="card-header">
          <h3 class="card-title">Current Controls</h3>
        </div> -->
        <!-- /.card-header -->
