    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-header mb-3">
          ...
          <h3  class="text-gray-800 text-hover-success fw-bold" style="font-size: 20px; margin-top: 21px;">Key Control Indicators</h3>
        ...
        <!-- end:card-header -->
          ...
          <!-- <div class="card-header">
            <h3 class="card-title">Key Control Indicators</h3>
          </div> -->
          <!-- /.card-header -->
