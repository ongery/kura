<template>
    ...
    <div class="app-toolbar py-3">
      ...
      <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
          ...
          <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <ForReviewIncidentManButton v-if="title === 'All Incindents'"></ForReviewIncidentManButton>

            <NewIncidentManButton v-if="title === 'All Incindents'"></NewIncidentManButton>
            <!-- Incidents Pending Review -->

            <BackButton  v-if="title != 'All Incindents'"></BackButton>
  ...
  import NewIncidentManButton from './NewIncidentManButton.vue';
  import ForReviewIncidentManButton from './ForReviewIncidentManButton.vue';
  
  export default {
      name:'IncidentManToolbar',
      props:['title', ],
      components:{BackButton, NewIncidentManButton, ForReviewIncidentManButton},
    ...
    manageHistory() {
        ...
        axios.post('/api/manage-logs', {
            'page_name': 'Incident Management',
            'log': 'User visited to the Incident Management'
        }, {
