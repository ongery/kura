                    ...
                    <div class="form-group mt-1">
                        <div class="card mb-5  mt-1">
                            ...
                            <div class="col col-md-10">
                                <input v-model="this.riskEventTitle" type="text" name="name" readonly class="form-control" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row card card-body p-8 m-1">
                ...
                <div class="row mb-5">
                    <div class="col-md-6 fv-row">
                        ...
                        <input v-model="form.Name" type="text" readonly placeholder="Name of Action" class="form-control form-control-solid" :class="{ 'is-invalid': form.errors.has('Name') }" />
                    </div>

                    <div class="col-md-6 fv-row">
                        <label class="fs-5 fw-semibold mb-2" for>Action Category</label>
                        <select name="type" v-model="form.Category" id="type" class="form-control" disabled :class="{ 'is-invalid': form.errors.has('type') }">
                ...
                <div class="row mb-5">
                    <div class="col-md-4 fv-row">
                        ...
                        <select name="type" v-model="form.Status" id="type" class="form-control" disabled :class="{ 'is-invalid': form.errors.has('Statuss') }">
                    ...
                    <div class="col-md-4 fv-row">
                        ...
                        <select name="type" v-model="form.Rating" id="type" class="form-control" disabled :class="{ 'is-invalid': form.errors.has('Rating') }">
                    ...
                    <div class="col-md-4 fv-row">
                        ...
                        <datepicker :bootstrap-styling="true" v-model="form.DueDate" :disabledDates="state.disabledDates" disabled :class="{ 'is-invalid': form.errors.has('DueDate') }" name="fromWhen">
                ...
                <div class="row mb-5 mt-3" v-for="(milestone, index) in form.milestones" :key="index">
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <input v-model="milestone.milestone_name" type="text" placeholder="Milestone Name" disabled class="form-control" />
                    </div>

                    <div class="col-md-3 fv-row">
                        <label class="fs-5 fw-semibold mb-2">Due Date</label>
                        <input v-model="milestone.due_date" type="date" class="form-control" disabled />
                    </div>

                    <div class="col-md-3 fv-row">
                        <label class="fs-5 fw-semibold mb-2">Status</label>
                        <select v-model="milestone.status" class="form-control" disabled>
                            <option value="0">Not Started (Not Due)</option>
                            <option value="1">WIP (On Course)</option>
                            <option value="2">WIP (Overdue)</option>
                            <option value="3">Not Started (Overdue)</option>
    ...
    export default {
        ...
        methods: {
            ...
            handleFileUpload(event, index) {
                // Attach the selected file to the milestone object
            ...
            updateAction() {
                ...
                // Append each milestone to the FormData
                this.form.milestones.forEach((milestone, index) => {
                    formData.append(`milestones[${index}][id]`, milestone.id);
                    formData.append(`milestones[${index}][action_id]`, milestone.action_id);
                ...
                this.form.put(`/api/actiontracking/update/${this.form.id}`, formData, {
                    headers: {
