                ...
                <div class="col-md-6 fv-row">
                    <form class="mb-10">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold fs-3 mb-1"> Select Key Control Indicators </span>
                        </h3>
                                                        ...
                                                        <table class="table table-hover  table-sm">
                                                            <tbody>
                                                                ...
                                                                <tr v-for="mode in mode1.riskRegisterData" :key="mode.id">
                                                                    ...
                                                                    <td :style="{ backgroundColor: getBgColor(mode.actionStatus) }">
                                                                        <a href="javascript:void(0)" :style="{ color: getTextColor(mode.actionStatus) }" class="text-dark fw-bolder d-block fs-6">{{ mode.actionStatus }}</a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
