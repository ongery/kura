<template>
     ...
     <div >
        	...
        	<!--begin::Header-->
            <!-- <h3 class="fw-bolder text-dark mb-10 mt-10 mx-0">{{ selectedItems.RiskName }}</h3> -->
            <!--end::Header-->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td  class="text-center" style="background-color: #ffcdcd;"><!-- Red -->
                                        ...
                                        <span class="text-muted fw-bolder d-block">{{selectedItem.RedKRIs}}</span>
                                    </td>
                                    <!-- <td class="text-end">
                                        <span class="badge badge-light-success">Approved</span>
                                    </td> -->
...
<!-- f2ecda -->
                                    <td  class="text-center" style="background-color: #f7a600; "><!-- Yellow -->
                                        <!-- fw-bolder text-gray-700 fs-5 text-end -->
                                        <a href="#" class="text-gray-800 text-hover-success mb-1 ">Non-Started Overdue</a>
