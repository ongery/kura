    ...
    <div>
        <div class="row mt-2">
            <div class="col-md-12">
                ...
                <ConsequenceMatrixContent :alldata="alldata"></ConsequenceMatrixContent>
            </div>
        </div>
...
<script>
import ConsequenceMatrixContent from './components/ConsequenceMatrixContent'
...
export default {
    ...
    components: { ConsequenceMatrixContent },
    methods: {
        getAuthToken() {
        ...
        manageHistory() {
            ...
            axios.post(
                '/api/manage-logs',
                {
                    page_name: 'Consequence Matrix',
                    log: 'User visited to the Consequence Matrix'
                },
                {
